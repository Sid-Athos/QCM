    ...
    <div class="dropdown" >
            <button class="btn btn-secondary dropdown-toggle"  type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" style="background-color:transparent;margin-right:-13px;margin-top:-8px;border:none" aria-labelledby="dropdownMenuButton">
                    <button class="btn btn-secondary" type="submit" name ="choice" value="call">Affecter un élève à une matière</button><br>
                    <button class="btn btn-secondary" type="submit" name ="choice" value="uncall">Désaffecter un élève à une matière</button><br>
                </div>
        </div>
        <div class="dropdown" >
            <button class="btn btn-secondary dropdown-toggle"  type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
